# Verbatim copy of core/rename_folders.py as of v2.0.0, kept only as the reference the
# rename-date tests compare the built-in "Date + name (Dutch)" profile against.
# Do not import this from the app.
